...
\newcommand{\docauthor}{Test Document Author}
...
\subsection{Model architecture of ConvNet2layers
...
\end{longtable}
\newpage
\subsection{Model architecture of MLP5layers
...
\end{longtable}
\newpage
\subsection{Model architecture of MLP2layers
